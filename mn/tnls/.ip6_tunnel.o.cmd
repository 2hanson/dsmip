cmd_/root/tnls/ip6_tunnel.o := gcc -m32 -Wp,-MD,/root/tnls/.ip6_tunnel.o.d  -nostdinc -isystem /usr/lib/gcc/i486-linux-gnu/4.3.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Os -pipe -msoft-float -mregparm=3 -freg-struct-return -mpreferred-stack-boundary=2  -march=i686 -ffreestanding -maccumulate-outgoing-args -DCONFIG_AS_CFI=1 -DCONFIG_AS_CFI_SIGNAL_FRAME=1 -Iinclude/asm-x86/mach-default -fomit-frame-pointer  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign    -DMODULE -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(ip6_tunnel)"  -D"KBUILD_MODNAME=KBUILD_STR(ip6_tunnel)" -c -o /root/tnls/.tmp_ip6_tunnel.o /root/tnls/ip6_tunnel.c

deps_/root/tnls/ip6_tunnel.o := \
  /root/tnls/ip6_tunnel.c \
...
/root/tnls/ip6_tunnel.o: $(deps_/root/tnls/ip6_tunnel.o)
