cmd_/root/dual-stack-mobile-ipv6-lh/databuff/databuff.mod.o := gcc -Wp,-MD,/root/dual-stack-mobile-ipv6-lh/databuff/.databuff.mod.o.d  -nostdinc -isystem /usr/lib/gcc/i486-linux-gnu/4.3.2/include -Iinclude  -I/lib/modules/2.6.29/build/arch/x86/include -include include/linux/autoconf.h -D__KERNEL__ -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Os -m32 -msoft-float -mregparm=3 -freg-struct-return -mpreferred-stack-boundary=2 -march=i686 -Wa,-mtune=generic32 -ffreestanding -DCONFIG_AS_CFI=1 -DCONFIG_AS_CFI_SIGNAL_FRAME=1 -pipe -Wno-sign-compare -fno-asynchronous-unwind-tables -mno-sse -mno-mmx -mno-sse2 -mno-3dnow -Iarch/x86/include/asm/mach-default -fno-stack-protector -fomit-frame-pointer -Wdeclaration-after-statement -Wno-pointer-sign -fwrapv  -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(databuff.mod)"  -D"KBUILD_MODNAME=KBUILD_STR(databuff)"  -DMODULE -c -o /root/dual-stack-mobile-ipv6-lh/databuff/databuff.mod.o /root/dual-stack-mobile-ipv6-lh/databuff/databuff.mod.c

deps_/root/dual-stack-mobile-ipv6-lh/databuff/databuff.mod.o := \
  /root/dual-stack-mobile-ipv6-lh/databuff/databuff.mod.c \
...
/root/dual-stack-mobile-ipv6-lh/databuff/databuff.mod.o: $(deps_/root/dual-stack-mobile-ipv6-lh/databuff/databuff.mod.o)
